  ...
  return (
    <div className="text-center sm:text-left">
      ...
      <address className="text-foreground-muted mt-3 space-y-2 text-sm not-italic sm:mt-4">
        <p>
          <a href="mailto:hello@webcraft.com" className="hover:text-foreground transition-colors">
            hello@webcraft.com
          </a>
        </p>
        <p>
    ...
    <footer className="bg-background-secondary" role="contentinfo">
      <Container>
        <div className="py-10 sm:py-12 lg:py-16">
          {/* Main footer content */}
          <div className="space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-8 lg:grid-cols-4 lg:gap-12">
            {/* Brand */}
