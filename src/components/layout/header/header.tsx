...
function Brand(): React.ReactElement {
  return (
    <Link
      href="/"
      className="text-foreground focus-visible:ring-primary-500 flex items-center gap-2 rounded-md font-display text-xl tracking-tight focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none"
