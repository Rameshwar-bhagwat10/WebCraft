/**
 * Work CTA Section
 * Call-to-action at the bottom of the work listing page
 *
...
export function WorkCTA(): React.ReactElement {
  return (
    <Section
      size="lg"
      ...
      <Container size="md">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Every project starts with a conversation. Tell us about your goals
