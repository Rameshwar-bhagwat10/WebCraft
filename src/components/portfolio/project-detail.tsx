...
export function ProjectDetail({
  ...
  const gradient =
    gradientColors[project.slug] || 'from-primary-500/20 to-primary-600/20';
    ...
    <>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            >
              <span
                className={cn(
                  ...
                  typeBadgeStyles[project.type] || typeBadgeStyles.Website
                )}
              >
                {project.type}
              </span>
            ...
            >
              <Text
                variant="secondary"
                size="lg"
                className="mb-10 max-w-3xl sm:text-xl"
              >
                {project.overview}
              </Text>
            </div>
            ...
            <div
              className={cn(
                'motion-scale-in relative aspect-video overflow-hidden rounded-2xl bg-linear-to-br',
                gradient
              )}
              style={
                {
      ...
      {metric && (
        <Section size="sm" background="secondary" aria-label="Project results">
          <Container>
            <div
              className="motion-slide-up flex flex-wrap items-center justify-center gap-8 sm:gap-16"
              style={
                {
                  '--motion-delay': '0s',
                  '--motion-duration': '0.5s',
            ...
            >
              <div className="text-center">
                <div className="text-primary-600 text-4xl font-bold sm:text-5xl">
                  {metric.value}
                </div>
                <div className="text-foreground-muted mt-1 text-sm capitalize">
                  {metric.label}
                </div>
              </div>
              {project.techStack && (
      ...
      <Section size="lg" background="primary">
        <Container size="lg">
          <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2 md:gap-12">
            <div
              className="motion-slide-up border-border bg-background rounded-2xl border p-6 sm:p-8"
              style={
                {
                  '--motion-delay': '0s',
                  '--motion-duration': '0.5s',
            ...
            <ul className="grid gap-4 sm:grid-cols-2">
              {project.features.map((feature, index) => (
                <li
                  key={index}
                  className={cn(
                    'motion-slide-up group flex items-start gap-3 rounded-xl p-4',
      ...
      <Section size="lg" background="primary" aria-labelledby="outcome-heading">
        <Container size="lg">
          <div className="mx-auto max-w-4xl">
            <div
              className="motion-slide-up mb-6"
              style={
                {
                  '--motion-delay': '0s',
                  '--motion-duration': '0.5s',
            ...
            >
              <Heading level={2} id="outcome-heading">
                The Result
              </Heading>
            </div>
            ...
            <div
              className={cn(
                'motion-slide-up relative overflow-hidden rounded-2xl p-6 sm:p-8',
                'from-primary-50 to-primary-100/50 bg-linear-to-br',
            ...
            >
              <div
                className="bg-primary-500 absolute top-0 left-0 h-full w-1 rounded-l-2xl"
                aria-hidden="true"
              />
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {project.techStack.map((tech) => (
                    <span
                      key={tech}
                      className="bg-background border-border hover:border-primary-200 hover:bg-primary-50 rounded-full border px-4 py-1.5 text-sm font-medium text-neutral-700 transition-colors"
                    >
                      {tech}
                    </span>
                  ))}
      ...
      {relatedProjects.length > 0 && (
        ...
        >
          <Container size="lg">
            <div className="mx-auto max-w-4xl">
              <div
                className="motion-slide-up mb-8 flex items-center justify-between"
                style={
                  {
                    '--motion-delay': '0s',
                    '--motion-duration': '0.5s',
              ...
              >
                <Heading level={2} id="related-heading">
                  More Projects
                </Heading>
                <Link
                  href="/work"
                ...
                {relatedProjects.map((relatedProject, index) => (
                  ...
                  >
                    <div className="p-5">
                      <span
                        className={cn(
                          'mb-2 inline-block rounded-full border px-2.5 py-0.5 text-xs font-medium',
                          typeBadgeStyles[relatedProject.type] ||
                            typeBadgeStyles.Website
                        )}
                      >
                        {relatedProject.type}
                      </span>
          ...
          >
            ...
            <div className="relative z-10">
              <h2
                ...
                className="motion-slide-up mb-4 text-2xl font-bold text-white sm:text-3xl"
                style={
                  {
                    '--motion-delay': '0.1s',
                    '--motion-duration': '0.5s',
              ...
              <p
                className="motion-slide-up mx-auto mb-8 max-w-md text-white/80"
                style={
                  {
                    '--motion-delay': '0.2s',
                    '--motion-duration': '0.5s',
              ...
              <div
                className="motion-slide-up flex flex-col items-center gap-4 sm:flex-row sm:justify-center"
                style={
                  {
                    '--motion-delay': '0.3s',
                    '--motion-duration': '0.5s',
              ...
              >
                <Button
                  asChild
                  size="lg"
                  className="text-primary-700 bg-white hover:bg-white/90"
                >
